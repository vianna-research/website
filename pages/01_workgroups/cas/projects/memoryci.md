...
<span class="glyphicon glyphicon-play" aria-hidden="true"></span>   ![Pictures showing no insertion trauma when using an electrode array equipped with an additional Nitinol wire.](memoryci/MemoryCI_Histo_Rau2016.jpg "Histological evaluation of an electrode array equipped with an additional Nitinol wire"){style="width:500px"}

<i class="icon-align-left"></i> ![Picture showing experimental Setup](memoryci/MemoryCI_Rau2016_Setup.jpg "Setup for temporal bone experiments at simulated body temperature"){style="width:500px"}
