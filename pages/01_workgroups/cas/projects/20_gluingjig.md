...
|    |                                                               |
| -: | :------------------------------------------------------------ |
| <span class="glyphicon glyphicon-education" aria-hidden="true"></span>    | Uhlenbusch L. (2017): _Investigation of accuracy and error sources of a surgical template made of bone cement_. Unpublished Bachelor Thesis. Joint research project between Department of Otolaryngology (MHH) and Institute of Mechatronic Systems (LUH). |
