...
-   [<span class="glyphicon glyphicon-link" aria-hidden="true"></span> Link to ST Mean Model](cochlearmodelling/ST_mean_model_2024_MHH_Froehlich.zip) (which contains the ST Mean Model).
...
|    |    |
| -- | -- |
| ![](cochlearmodelling/Froehlich2024Fig1.jpg) | ![](cochlearmodelling/Froehlich2024_Fig2.jpg)  |
...
-   [<span class="glyphicon glyphicon-link" aria-hidden="true"></span> Link to i-path model](cochlearmodelling/uncoiled_st_ipath.zip). 
-   [<span class="glyphicon glyphicon-link" aria-hidden="true"></span> Link to oc-path model](cochlearmodelling/uncoiled_st_ocpath.zip).
