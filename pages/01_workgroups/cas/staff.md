...
| ![Portrait](staff/Portrait_JinhanZ.jpg){style="width:70px"}                             | Jinhan Zhu           | Student Research Project (2023): _Influence of anatomical parameters on insertion forces in porcine cochlear specimens._ & <br> Master Thesis (2024): _Feasibility study on insertion force measurement in a hydraulic system using an integrated force sensor._ |
...
| ![Portrait](staff/empty_female.png){style="width:70px"}	| Franziska Niemann | Master Thesis (2023) |
| ![Portrait](staff/empty_male.png){style="width:70px"}	| Christos Karamoukis | Master Thesis (2023) |
...
|	![Portrait](staff/empty_female.png){style="width:70px"}                                | Nina Aldag								| Student Research Project (2019): _Parametric study to identify factors influencing the characteristics of forces during the insertion of cochlear implant electrode arrays._ |
