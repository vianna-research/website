...
For presenting at EnFI-2014 it is compulsory to hand in the abstract in the [standard layout](EnFI-2015_template.pdf) along the email address: **enfi-2015(at)mh-hannover.de** with the subject **[Abstract]Lastname,Firstname**. Please embed the figures in a printer friendly quality (about 300 dpi) in the document, but avoid abstracts files bigger than 2 MB.
